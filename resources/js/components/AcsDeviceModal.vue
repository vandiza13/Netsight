          ...
          <div class="form-stack">
            ...
            <div class="form-group">
              ...
              <div class="input-icon-wrap">
                ...
                <input v-model="form.password" :type="showPassword ? 'text' : 'password'" required minlength="8" class="input-modern input-has-icon input-has-action" placeholder="Minimum 8 karakter">
              ...
              <span class="form-hint">Minimum 8 karakter</span>
            </div>
          </div>
