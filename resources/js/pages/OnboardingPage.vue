    ...
    <div class="login-card glass-card glass-card--elevated onboarding-card" :class="{ 'login-card--shake': shakeCard }">
      ...
      <form class="login-form" @submit.prevent="handleSubmit">
        ...
        <div class="onboarding-section">
          ...
          <div v-else-if="totpData" class="mt-4">
            <div class="totp-setup-box flex flex-col md:flex-row gap-4 items-center p-4 rounded-lg bg-black/20 border border-gray-800">
              <div class="shrink-0 bg-white p-2 rounded-md">
...
.copy-success { color: #10b981; font-size: 0.75rem; margin-left: 8px; letter-spacing: normal; }
